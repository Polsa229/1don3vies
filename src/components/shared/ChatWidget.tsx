...
export function ChatWidget() {
  ...
  const quickQuestions =
    lang === "fr" ? QUICK_QUESTIONS_FR : QUICK_QUESTIONS_EN;
    ...
    setMessages((prev) => [
      ...
      { role: "user", text: q },
      {
        ...
        text:
          answers[q] ||
          (lang === "fr"
            ? "Je vous invite à consulter la section correspondante sur cette page."
            : "Please check the relevant section on this page."),
      },
    ]);
  }
          ...
          >
            ...
            <div className="p-3 border-t border-warmgray-200 bg-white flex items-center gap-2">
              <input
                ...
                placeholder={
                  lang === "fr" ? "Écrivez un message..." : "Type a message..."
                }
