...
export function SectionHeading({ eyebrowKey, titleKey, subtitleKey, center = true }: SectionHeadingProps) {
  const { t } = useI18n();
  ...
  return (
    <div className="relative py-16 sm:py-20 overflow-hidden">
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
        <div className="w-full max-w-3xl h-px bg-gradient-to-r from-transparent via-bordeaux-300 to-transparent" />
      </div>
      <blockquote className="relative text-center px-6">
        <p className="heading-display text-2xl sm:text-3xl lg:text-4xl text-bordeaux-800 italic leading-relaxed text-balance">
